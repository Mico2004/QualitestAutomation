...
public class TC18880ValidateTheSourceTypeAsRecordingTitleInSearchFieldOnTheAllCoursesLevel {
...
//		driver=new InternetExplorerDriver(capability);
		...
		edit_recording_properties_window = PageFactory.initElements(driver, EditRecordingPropertiesWindow.class);
		 ...
		 System.out.println("Starting the test: TC18880ValidateTheSourceTypeAsRecordingTitleInSearchFieldOnTheAllCoursesLevel at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TC18880ValidateTheSourceTypeAsRecordingTitleInSearchFieldOnTheAllCoursesLevel at " + DateToStr,
		 "Starting the test: TC18880ValidateTheSourceTypeAsRecordingTitleInSearchFieldOnTheAllCoursesLevel at " + DateToStr, LogAs.PASSED, null);
	...
	@Test(description = "TC 18880 Validate The Source Type As Recording Title In Search Field On The All Courses Level")
	public void test18880() throws Exception
	{
		...
		for(int type_of_user = 0; type_of_user < 3; type_of_user++) {
			...
			search_page.verfiyBreadcrumbStructureDisplayedAsCoursesXResultsFound(current_course, recording_title_for_the_test);
