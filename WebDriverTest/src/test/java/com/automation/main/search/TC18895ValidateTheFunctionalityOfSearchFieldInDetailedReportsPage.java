...
public class TC18895ValidateTheFunctionalityOfSearchFieldInDetailedReportsPage {
...
//		
		...
		edit_recording = PageFactory.initElements(driver, EditRecording.class);
		 ...
		 System.out.println("Starting the test: TC18895ValidateTheFunctionalityOfSearchFieldInDetailedReportsPage at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TC18895ValidateTheFunctionalityOfSearchFieldInDetailedReportsPage at " + DateToStr,
		 "Starting the test: TC18895ValidateTheFunctionalityOfSearchFieldInDetailedReportsPage at " + DateToStr, LogAs.PASSED, null);
