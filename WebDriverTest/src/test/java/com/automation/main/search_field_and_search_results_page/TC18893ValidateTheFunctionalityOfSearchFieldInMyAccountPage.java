...
public class TC18893ValidateTheFunctionalityOfSearchFieldInMyAccountPage {
...
//		driver=new InternetExplorerDriver(capability);
		...
		edit_recording = PageFactory.initElements(driver, EditRecording.class);
		 ...
		 System.out.println("Starting the test: TC18893ValidateTheFunctionalityOfSearchFieldInMyAccountPage at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TC18893ValidateTheFunctionalityOfSearchFieldInMyAccountPage at " + DateToStr,
		 "Starting the test: TC18893ValidateTheFunctionalityOfSearchFieldInMyAccountPage at " + DateToStr, LogAs.PASSED, null);
