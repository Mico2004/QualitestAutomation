	...
	// Set Property for ATU Reporter Configuration
		...
		public void setup() {
			...
			mangage_adhoc_courses_membership_window = PageFactory.initElements(driver,
			 ...
			 System.out.println("Starting the test: TC17938VerifyPastCourseWithTestRecording at " + DateToStr);
			 ATUReports.add("Message window.", "Starting the test: TC17938VerifyPastCourseWithTestRecording at " + DateToStr,
			 "Starting the test: TC17938VerifyPastCourseWithTestRecording at " + DateToStr, LogAs.PASSED, null);
