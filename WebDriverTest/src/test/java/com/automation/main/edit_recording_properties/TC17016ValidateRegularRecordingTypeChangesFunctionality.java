...
public class TC17016ValidateRegularRecordingTypeChangesFunctionality  {
	...
	public void setup() {
		 ...
		 System.out.println("Starting the test: TC17016ValidateRegularRecordingTypeChangesFunctionality at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TC17016ValidateRegularRecordingTypeChangesFunctionality at " + DateToStr, "Starting the test: TC17016ValidateRegularRecordingTypeChangesFunctionality at " + DateToStr, LogAs.PASSED, null);	
	}
	...
	@Test (description="TC17016 Validate regular recording type changes functionality")
	public void test17016() throws InterruptedException, ParseException {
		...
		//16. The recording information - "recorded by" value has changed to the STUDENT user selected earlier.
		...
		//18.Return to the "Recordings" tab
		record.clickOnRecordingsTab();
		
		//19.Check some recording respective checkbox 
		...
		//32.The recording is no longer displayed in the "Recordings" tab content.
