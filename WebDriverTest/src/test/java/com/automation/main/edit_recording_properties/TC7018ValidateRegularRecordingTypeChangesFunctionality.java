...
public class TC7018ValidateRegularRecordingTypeChangesFunctionality  {
	...
	public void setup() {
		 ...
		 System.out.println("Starting the test: TC7018ValidateRegularRecordingTypeChangesFunctionality at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TC7018ValidateRegularRecordingTypeChangesFunctionality at " + DateToStr, "Starting the test: TC7018ValidateRegularRecordingTypeChangesFunctionality at " + DateToStr, LogAs.PASSED, null);	
	}
	...
	@Test (description="TC7018 Validate regular recording type changes functionality")
	public void test7018() throws InterruptedException, ParseException {
