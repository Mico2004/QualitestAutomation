...
public class TC17011ValidateRecordingDateChangeFunctionality {
	...
	public void setup() {
		try {
		 ...
		 System.out.println("Starting the test: TC17011ValidateRecordingDateChangeFunctionality at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TC17011ValidateRecordingDateChangeFunctionality at " + DateToStr, "Starting the test: TC17011ValidateRecordingDateChangeFunctionality at " + DateToStr, LogAs.PASSED, null);	
	}
	...
	@Test (description="TC17011 validate recording date change functionality")
	public void test17011() throws InterruptedException, ParseException {
