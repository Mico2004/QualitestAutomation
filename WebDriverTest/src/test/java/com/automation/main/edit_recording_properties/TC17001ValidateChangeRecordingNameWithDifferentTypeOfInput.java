...
public class TC17001ValidateChangeRecordingNameWithDifferentTypeOfInput {
	...
	public void test17001() throws InterruptedException, ParseException {
		...
		record.verifyThatTheRecordNameEqualsFromTheString(newNameWithOutGaps,1);
		...
		record.verifyThatTheRecordNameEqualsFromTheString(newName,2);
		...
		record.verifyThatTheRecordNameEqualsFromTheString(newName,3);
