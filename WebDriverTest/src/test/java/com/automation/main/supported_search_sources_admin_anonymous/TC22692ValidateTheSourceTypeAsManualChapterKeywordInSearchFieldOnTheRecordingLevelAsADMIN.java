...
public class TC22692ValidateTheSourceTypeAsManualChapterKeywordInSearchFieldOnTheRecordingLevelAsADMIN {
	// Set Property for ATU Reporter Configuration
		...
		public void setup() {
			...
			ATUReports.add("Message window.", "Starting the test: TC22692ValidateTheSourceTypeAsManualChapterKeywordInSearchFieldOnTheRecordingLevelAsADMIN at " + DateToStr,
			"Starting the test: TC22692ValidateTheSourceTypeAsManualChapterKeywordInSearchFieldOnTheRecordingLevelAsADMIN at " + DateToStr, LogAs.PASSED, null);	
