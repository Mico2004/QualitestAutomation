...
public class TC22663ValidateSourceTypeAsRecordingTitleInSearchFieldOnRecordingLevelLoginAsGUEST {
	// Set Property for ATU Reporter Configuration
		...
		public void setup() {
			...
			System.out.println("Starting the test: TC22663ValidateSourceTypeAsRecordingTitleInSearchFieldOnRecordingLevelLoginAsGUEST at " + DateToStr);
			ATUReports.add("Message window.", "Starting the test: TC22663ValidateSourceTypeAsRecordingTitleInSearchFieldOnRecordingLevelLoginAsGUEST at " + DateToStr,
