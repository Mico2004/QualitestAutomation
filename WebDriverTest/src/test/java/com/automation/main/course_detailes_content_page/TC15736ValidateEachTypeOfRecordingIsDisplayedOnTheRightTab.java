...
public class TC15736ValidateEachTypeOfRecordingIsDisplayedOnTheRightTab {
...
//		driver=new InternetExplorerDriver(capability);
		...
		delete_menu = PageFactory.initElements(driver, DeleteMenu.class);
		 ...
		 System.out.println("Starting the test: TC15736ValidateEachTypeOfRecordingIsDisplayedOnTheRightTab at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TC15736ValidateEachTypeOfRecordingIsDisplayedOnTheRightTab at " + DateToStr,
		 "Starting the test: TC15736ValidateEachTypeOfRecordingIsDisplayedOnTheRightTab at " + DateToStr, LogAs.PASSED, null);
