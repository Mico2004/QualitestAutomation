...
public class TC6807VerifyThatWhenBothTheInstitutionAndCourseTestingPoliciesAreDisabledTheRecorderIsLaunched {
	...
	public void setup() {
		 ...
		 System.out.println("Starting the test: TC6807VerifyThatWhenBothTheInstitutionAndCourseTestingPoliciesAreDisabledTheRecorderIsLaunched at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TC6807VerifyThatWhenBothTheInstitutionAndCourseTestingPoliciesAreDisabledTheRecorderIsLaunched at " + DateToStr, "Starting the test: TC6807VerifyThatWhenBothTheInstitutionAndCourseTestingPoliciesAreDisabledTheRecorderIsLaunched at " + DateToStr, LogAs.PASSED, null);	
	}
	...
	@Test (description="TC6807 Verify that when both the Institution and Course testing policies are disabled - the recorder is launched")
	public void test6807() throws InterruptedException, AWTException {
		...
		course_settings_page.forceWebElementToBeUnselected(course_settings_page.checkbox_show_testing_policy, "Enable show testing policy");
		...
		//15.verify that The modal window is closed and the PC/Mac Recorder opens.
