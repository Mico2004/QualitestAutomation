...
public class TC22662ValidateInvalidSearchOfRecordingTitleInSearchFieldOnRecordingLevelLoginAsADMIN {
	...
	public void setup() {
		...
		System.out.println("Starting the test: TC22662ValidateInvalidSearchOfRecordingTitleInSearchFieldOnRecordingLevelLoginAsADMIN at " + DateToStr);
		ATUReports.add("Message window.", "Starting the test: TC22662ValidateInvalidSearchOfRecordingTitleInSearchFieldOnRecordingLevelLoginAsADMIN at " + DateToStr,
		"Starting the test: TC22662ValidateInvalidSearchOfRecordingTitleInSearchFieldOnRecordingLevelLoginAsADMIN at " + DateToStr, LogAs.PASSED, null);	
