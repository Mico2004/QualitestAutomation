...
public class TC15458AddMpgFile {
	...
	public void setup() {
		...
		mangage_adhoc_courses_membership_window = PageFactory.initElements(driver,
		 ...
		 System.out.println("Starting the test: TC15458AddMpgFile at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TC15458AddMpgFile at " + DateToStr, "Starting the test: TC15458AddMpgFile at " + DateToStr, LogAs.PASSED, null);	
	}
	...
	public void test17929() throws Exception {
		...
		String fullPathToFile = "\\workspace\\QualitestAutomation\\resources\\documents\\Moshik_testMpg.mpg";
		String file_name = "Moshik_testMpg.mpg";
		// 1.load page
