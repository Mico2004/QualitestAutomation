...
public class DefaultInstructorReportSection extends AbstractInstructorReportPage implements CustomAnalysisDropDown {

    @FindBy(css = "option[value='0']")
    protected WebElement option;

    public DefaultInstructorReportSection(WebDriver browser) {
        super(browser);
    }
