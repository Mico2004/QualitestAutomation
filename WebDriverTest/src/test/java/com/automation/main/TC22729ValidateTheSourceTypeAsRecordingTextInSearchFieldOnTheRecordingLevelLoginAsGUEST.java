...
public class TC22729ValidateTheSourceTypeAsRecordingTextInSearchFieldOnTheRecordingLevelLoginAsGUEST {
	...
	public void setup() {
		...
		System.out.println("Starting the test: TC22729ValidateTheSourceTypeAsRecordingTextInSearchFieldOnTheRecordingLevelLoginAsGUEST at " + DateToStr);
		ATUReports.add("Message window.", "Starting the test: TC22729ValidateTheSourceTypeAsRecordingTextInSearchFieldOnTheRecordingLevelLoginAsGUEST at " + DateToStr,
		"Starting the test: TC22729ValidateTheSourceTypeAsRecordingTextInSearchFieldOnTheRecordingLevelLoginAsGUEST at " + DateToStr, LogAs.PASSED, null);	
