...
public class TestSuitePreSetCopyRecordings_Admin {
...
//		System.setProperty("webdriver.edge.driver", "src/test/resources/MicrosoftWebDriver.exe");
		...
		erp_window = PageFactory.initElements(driver, EditRecordinPropertiesWindow.class);
		 ...
		 System.out.println("Starting the test: TestSuitePreSetCopyRecordings_Admin at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TestSuitePreSetCopyRecordings_Admin at " + DateToStr,
		 "Starting the test: TestSuitePreSetCopyRecordings_Admin at " + DateToStr, LogAs.PASSED, null);	
	}
