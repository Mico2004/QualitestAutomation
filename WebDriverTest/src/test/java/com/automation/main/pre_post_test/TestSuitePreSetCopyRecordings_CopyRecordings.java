...
public class TestSuitePreSetCopyRecordings_CopyRecordings {
...
//		System.setProperty("webdriver.edge.driver", "src/test/resources/MicrosoftWebDriver.exe");
		...
		Date curDate = new Date();
		 ...
		 System.out.println("Starting the test: TestSuitePreSetCopyRecordings_CopyRecordings at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TestSuitePreSetCopyRecordings_CopyRecordings at " + DateToStr,
		 "Starting the test: TestSuitePreSetCopyRecordings_CopyRecordings at " + DateToStr, LogAs.PASSED, null);
