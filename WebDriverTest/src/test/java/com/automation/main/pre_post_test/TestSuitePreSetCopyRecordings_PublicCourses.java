...
public class TestSuitePreSetCopyRecordings_PublicCourses {
...
//		System.setProperty("webdriver.edge.driver", "src/test/resources/MicrosoftWebDriver.exe");
		...
		Date curDate = new Date();
		 ...
		 System.out.println("Starting the test: TestSuitePreSetCopyRecordings_PublicCourses at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TestSuitePreSetCopyRecordings_PublicCourses at " + DateToStr,
		 "Starting the test: TestSuitePreSetCopyRecordings_PublicCourses at " + DateToStr, LogAs.PASSED, null);
	...
	@Test(description = "Test Suite Pre Set Copy Recordings_PublicCourses")
	public void testSuitePreSetCopyRecordings_PublicCourses() throws InterruptedException {
