...
public class TestSuitePreSetCopyRecordings_BookmarkTab {
...
//		System.setProperty("webdriver.edge.driver", "src/test/resources/MicrosoftWebDriver.exe");
		...
		erp_window = PageFactory.initElements(driver, EditRecordingPropertiesWindow.class);
		 ...
		 System.out.println("Starting the test: TestSuitePreSetCopyRecordings_BookmarkTab at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TestSuitePreSetCopyRecordings_BookmarkTab at " + DateToStr,
		 "Starting the test: TestSuitePreSetCopyRecordings_BookmarkTab at " + DateToStr, LogAs.PASSED, null);	
	}
...
////
	...
	public void testSuitePreSetCopyRecordings_BookmarkTab() throws InterruptedException {
