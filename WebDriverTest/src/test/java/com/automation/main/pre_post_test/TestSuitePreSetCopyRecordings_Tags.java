...
public class TestSuitePreSetCopyRecordings_Tags {
...
//		System.setProperty("webdriver.edge.driver", "src/test/resources/MicrosoftWebDriver.exe");
		...
		Date curDate = new Date();
		 ...
		 System.out.println("Starting the test: TestSuitePreSetCopyRecordings_Tags at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TestSuitePreSetCopyRecordings_Tags " + DateToStr,
		 "Starting the test: TestSuitePreSetCopyRecordings_Tags at " + DateToStr, LogAs.PASSED, null);
	...
	public void testSuitePreSetCopyRecordings_Tags() throws InterruptedException {
