...
public class TestSuitePreSetCopyRecordings_PrivateCourses {
...
//		System.setProperty("webdriver.edge.driver", "src/test/resources/MicrosoftWebDriver.exe");
		...
		Date curDate = new Date();
		 ...
		 System.out.println("Starting the test: TestSuitePreSetCopyRecordings_PrivateCourses at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TestSuitePreSetCopyRecordings_PrivateCourses at " + DateToStr,
		 "Starting the test: TestSuitePreSetCopyRecordings_PrivateCourses at " + DateToStr, LogAs.PASSED, null);
	...
	@Test(description = "Test Suite Pre Set Copy Recordings_PrivateCourses")
	public void testSuitePreSetCopyRecordings_PrivateCourses() throws InterruptedException {
