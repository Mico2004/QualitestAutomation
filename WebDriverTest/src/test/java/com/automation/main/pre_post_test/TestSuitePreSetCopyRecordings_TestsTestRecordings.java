...
public class TestSuitePreSetCopyRecordings_TestsTestRecordings {
...
//		System.setProperty("webdriver.edge.driver", "src/test/resources/MicrosoftWebDriver.exe");
		...
		Date curDate = new Date();
		 ...
		 System.out.println("Starting the test: TestSuitePreSetCopyRecordings_TestsTestRecordings at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TestSuitePreSetCopyRecordings_TestsTestRecordings " + DateToStr,
		 "Starting the test: TestSuitePreSetCopyRecordings_TestsTestRecordings at " + DateToStr, LogAs.PASSED, null);
