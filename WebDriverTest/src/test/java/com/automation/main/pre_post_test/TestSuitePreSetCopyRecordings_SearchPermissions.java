...
public class TestSuitePreSetCopyRecordings_SearchPermissions {
...
//		System.setProperty("webdriver.edge.driver", "src/test/resources/MicrosoftWebDriver.exe");
		...
		Date curDate = new Date();
		 ...
		 System.out.println("Starting the test: TestSuitePreSetCopyRecordings_SearchPermissions at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TestSuitePreSetCopyRecordings_SearchPermissions at " + DateToStr,
		 "Starting the test: TestSuitePreSetCopyRecordings_SearchPermissions at " + DateToStr, LogAs.PASSED, null);
