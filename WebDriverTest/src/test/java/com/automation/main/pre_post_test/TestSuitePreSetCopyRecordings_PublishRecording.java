...
public class TestSuitePreSetCopyRecordings_PublishRecording {
...
//		System.setProperty("webdriver.edge.driver", "src/test/resources/MicrosoftWebDriver.exe");
		...
		Date curDate = new Date();
		 ...
		 System.out.println("Starting the test: TestSuitePreSetCopyRecordings_PublishRecording at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TestSuitePreSetCopyRecordings_PublishRecording " + DateToStr,
		 "Starting the test: TestSuitePreSetCopyRecordings_PublishRecording " + DateToStr, LogAs.PASSED, null);
