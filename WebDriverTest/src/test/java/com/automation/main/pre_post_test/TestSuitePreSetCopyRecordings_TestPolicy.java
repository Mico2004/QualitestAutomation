...
public class TestSuitePreSetCopyRecordings_TestPolicy {
...
//		System.setProperty("webdriver.edge.driver", "src/test/resources/MicrosoftWebDriver.exe");
		...
		Date curDate = new Date();
		 ...
		 System.out.println("Starting the test: TestSuitePreSetCopyRecordings_TestPolicy at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TestSuitePreSetCopyRecordings_TestPolicy " + DateToStr,
		 "Starting the test: TestSuitePreSetCopyRecordings_TestPolicy at " + DateToStr, LogAs.PASSED, null);
