...
public class TC10116ValidateFunctionalityOfNeverOptionInThePublishWindowSeveralRecording {
	...
	public void setup() {
		 ...
		 System.out.println("Starting the test: TC10116ValidateFunctionalityOfNeverOptionInThePublishWindowSeveralRecording at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TC10116ValidateFunctionalityOfNeverOptionInThePublishWindowSeveralRecording at " + DateToStr, "Starting the test: TC10116ValidateFunctionalityOfNeverOptionInThePublishWindowSeveralRecording at " + DateToStr, LogAs.PASSED, null);	
	}
	...
	@Test (description="TC10116 Validate functionality of never option in the publish window several recording")
	public void test10116() throws InterruptedException, ParseException {
		...
		record.checkThatTheirAreNoRecordsInTheRecordingsPage();

		//12.Validate the student tab aren't displayed
