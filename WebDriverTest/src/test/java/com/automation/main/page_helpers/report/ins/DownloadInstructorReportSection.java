...
public class DownloadInstructorReportSection extends AbstractInstructorReportPage implements CustomAnalysisDropDown {

    @FindBy(css = "option[value='3']")
    protected WebElement option;

    public DownloadInstructorReportSection(WebDriver browser) {
        super(browser);
    }
