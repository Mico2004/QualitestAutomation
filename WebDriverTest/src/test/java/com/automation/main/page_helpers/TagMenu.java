...
public class TagMenu extends Page {
    ...
    WebElement tag_window_title;
    @FindBy(id = "ModalDialogHeaderWrap")
    public WebElement tag_window_title_background;
    @FindBy(css = ".emphasis")
    WebElement tag_window_text;
    @FindBy(xpath = ".//*[@id='tagRecordingWindow']/form/div[1]/table/tbody/tr/th[2]")
    WebElement nameLabel;
    @FindBy(xpath = ".//*[@id='tagRecordingWindow']/form/div[1]/table/tbody/tr/th[3]")
    WebElement privateLabel;
    @FindBy(xpath = ".//*[@id='tagRecordingWindow']/form/div[1]/table/tbody/tr/th[4]")
    WebElement editLabel;
    @FindBy(xpath = ".//*[@id='tagRecordingWindow']/form/div[1]/div[1]/table/tbody/tr[1]/td[1]/input")
    public WebElement first_tag_checkbox;
    @FindBy(xpath = ".//*[@id='tagRecordingWindow']/form/div[1]/div[1]/table/tbody/tr[1]/td[3]/input")
    public WebElement first_private_checkbox;
    @FindBy(xpath = ".//*[@id='tagRecordingWindow']/form/div[1]/div[1]/table/tbody/tr[1]/td[2]")
    public WebElement first_name;
    @FindBy(xpath = ".//*[@id='tagRecordingWindow']/form/div[1]/div[1]/table/tbody")
    public WebElement tableOfTags;
    @FindBy(xpath = ".//*[@id='tagRecordingWindow']/form/div[1]/div[2]/div[1]")
    public WebElement edit_background;
    @FindBy(xpath = ".//*[@id='tagRecordingWindow']/form/div[1]/div[2]/div[1]/span")
    public WebElement edit_title;
    @FindBy(xpath = ".//*[@id='tagRecordingWindow']/form/div[1]/div[2]/div[2]/div/label")
    public WebElement private_edit_label;
    @FindBy(xpath = ".//*[@id='tagRecordingWindow']/form/div[1]/div[2]/div[3]/button[1]")
    public WebElement cancel_edit_button;
    @FindBy(xpath = ".//*[@id='tagRecordingWindow']/form/div[1]/div[2]/div[3]/button[2]")
    public WebElement submit_edit_button;
    @FindBy(xpath = ".//*[@id='tagRecordingWindow']/form/div[1]/div[2]/div[3]/button[3]")
    public WebElement delete_button;

    @FindBy(id = "CreateButton")
    public WebElement create_new_tag_button;
    @FindBy(id = "CancelButton")
    public WebElement cancel_button;
    @FindBy(id = "ApplyButton")
    public WebElement apply_button;
    @FindBy(id = "CheckAll")
    public List<WebElement> header_checkbox;
    @FindBy(id = "isPrivate")
    public WebElement privte_checkbox;
    @FindBy(id = "tagName")
    public WebElement edit_new_tag_input;
    @FindBy(css = ".btnWrap>.btn.btn-primary")
    List<WebElement> delete_submit_tags_list;
    @FindBy(css = ".deleteTag.tagIcon")
    public List<WebElement> delete_tag_button_list;
    @FindBy(css = ".editTag.tagIcon")
    public List<WebElement> edit_tag_button_list;
