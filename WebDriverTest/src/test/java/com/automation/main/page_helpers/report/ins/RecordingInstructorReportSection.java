...
public class RecordingInstructorReportSection extends AbstractInstructorReportPage implements CustomAnalysisDropDown {
    @FindBy(css = "option[value='2']")
    protected WebElement option;

    public RecordingInstructorReportSection(WebDriver browser) {
        super(browser);
    }
