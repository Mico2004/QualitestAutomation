...
public class DefaultAdminReportSection extends AbstractAdminReportPage implements CustomAnalysisDropDown {

    @FindBy(css = "option[value='0']")
    protected WebElement option;

    public DefaultAdminReportSection(WebDriver browser) {
        super(browser);
    }
