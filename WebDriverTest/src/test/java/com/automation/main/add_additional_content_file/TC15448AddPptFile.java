...
public class TC15448AddPptFile {
	...
	public void setup() {
		...
		mangage_adhoc_courses_membership_window = PageFactory.initElements(driver,
		 ...
		 System.out.println("Starting the test: TC15448AddPptFile at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TC15448AddPptFile at " + DateToStr, "Starting the test: TC15448AddPptFile at " + DateToStr, LogAs.PASSED, null);	
	}
