...
public class TC15457AddMovFile {
	...
	public void setup(){// throws ATUTestRecorderException {
		...
		mangage_adhoc_courses_membership_window = PageFactory.initElements(driver,
		 ...
		 System.out.println("Starting the test: TC15457AddMovFile at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TC15457AddMovFile at " + DateToStr, "Starting the test: TC15457AddMovFile at " + DateToStr, LogAs.PASSED, null);	
	}
