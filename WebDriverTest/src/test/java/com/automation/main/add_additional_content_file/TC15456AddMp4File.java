...
public class TC15456AddMp4File {
	...
	public void setup() {
		...
		mangage_adhoc_courses_membership_window = PageFactory.initElements(driver,
		 ...
		 System.out.println("Starting the test: TC15456AddMp4File at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TC15456AddMp4File at " + DateToStr, "Starting the test: TC15456AddMp4File at " + DateToStr, LogAs.PASSED, null);	
	}
