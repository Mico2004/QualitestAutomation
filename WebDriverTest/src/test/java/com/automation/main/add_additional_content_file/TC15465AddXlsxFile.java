...
public class TC15465AddXlsxFile {
	...
	public void setup() {
		...
		mangage_adhoc_courses_membership_window = PageFactory.initElements(driver,
		 ...
		 System.out.println("Starting the test: TC15465AddXlsxFile at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TC15465AddXlsxFile at " + DateToStr, "Starting the test: TC15465AddXlsxFile at " + DateToStr, LogAs.PASSED, null);	
	}
	...
	public void test15465() throws Exception {

		String fullPathToFile = "\\src\\test\\resources\\resouces-to-upload\\Moshik_testXlsx.xlsx";
