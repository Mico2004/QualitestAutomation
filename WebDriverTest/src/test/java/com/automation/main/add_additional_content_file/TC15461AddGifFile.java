...
public class TC15461AddGifFile {
	...
	public void setup() {
		...
		mangage_adhoc_courses_membership_window = PageFactory.initElements(driver,
		 ...
		 System.out.println("Starting the test: TC15461AddGifFile at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TC15461AddGifFile at " + DateToStr, "Starting the test: TC15461AddGifFile at " + DateToStr, LogAs.PASSED, null);	
	}
