...
public class TC15453AddPdfFile {
	...
	public void setup() {
		...
		mangage_adhoc_courses_membership_window = PageFactory.initElements(driver,
		 ...
		 System.out.println("Starting the test: TC15453AddPdfFile at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TC15453AddPdfFile at " + DateToStr, "Starting the test: TC15453AddPdfFile at " + DateToStr, LogAs.PASSED, null);	
	}
	...
	public void test15453() throws Exception {

		String fullPathToFile = "\\src\\test\\resources\\resouces-to-upload\\Moshik_testPdf.pdf";
		String file_name = "Moshik_testPdf.pdf";
		// 1.load page
