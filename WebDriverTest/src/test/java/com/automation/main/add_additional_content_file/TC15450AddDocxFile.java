...
public class TC15450AddDocxFile {
	...
	public void setup() {
		...
		mangage_adhoc_courses_membership_window = PageFactory.initElements(driver,
		 ...
		 System.out.println("Starting the test: TC15450AddDocxFile at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TC15450AddDocxFile at " + DateToStr, "Starting the test: TC15450AddDocxFile at " + DateToStr, LogAs.PASSED, null);	
	}
