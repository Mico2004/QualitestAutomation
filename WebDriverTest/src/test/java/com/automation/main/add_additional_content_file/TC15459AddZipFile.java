...
public class TC15459AddZipFile {
	...
	public void setup() {
		...
		mangage_adhoc_courses_membership_window = PageFactory.initElements(driver,
		 ...
		 System.out.println("Starting the test: TC15459AddZipFile at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TC15459AddZipFile at " + DateToStr, "Starting the test: TC15459AddZipFile at " + DateToStr, LogAs.PASSED, null);	
	}
