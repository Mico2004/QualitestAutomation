...
public class TC15451AddRtfFile {
	...
	public void setup() {
		...
		mangage_adhoc_courses_membership_window = PageFactory.initElements(driver,
		 ...
		 System.out.println("Starting the test: TC15451AddRtfFile at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TC15451AddRtfFile at " + DateToStr, "Starting the test: TC15451AddRtfFile at " + DateToStr, LogAs.PASSED, null);	
	}
	...
	public void test15451() throws Exception {
		...
		String fullPathToFile = "\\src\\test\\resources\\resouces-to-upload\\sample.rtf";
