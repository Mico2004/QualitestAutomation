...
public class TC15462AddJpgFile {
	...
	public void setup() {
		...
		mangage_adhoc_courses_membership_window = PageFactory.initElements(driver,
		 ...
		 System.out.println("Starting the test: TC15462AddJpgFile at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TC15462AddJpgFile at " + DateToStr, "Starting the test: TC15462AddJpgFile at " + DateToStr, LogAs.PASSED, null);	
	}
