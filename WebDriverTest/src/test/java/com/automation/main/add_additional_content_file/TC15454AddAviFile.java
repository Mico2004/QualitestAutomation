...
public class TC15454AddAviFile {
...
//		
		...
		mangage_adhoc_courses_membership_window = PageFactory.initElements(driver,
		 ...
		 System.out.println("Starting the test: TC15454AddAviFile at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TC15454AddAviFile at " + DateToStr, "Starting the test: TC15454AddAviFile at " + DateToStr, LogAs.PASSED, null);	
	}
