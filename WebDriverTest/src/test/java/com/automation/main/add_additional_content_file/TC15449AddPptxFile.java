...
public class TC15449AddPptxFile {
	...
	public void setup() {
		...
		mangage_adhoc_courses_membership_window = PageFactory.initElements(driver,
		 ...
		 System.out.println("Starting the test: TC15449AddPptxFile at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TC15449AddPptxFile at " + DateToStr, "Starting the test: TC15449AddPptxFile at " + DateToStr, LogAs.PASSED, null);	
	}
	...
	public void test15449() throws Exception {
		...
		String fullPathToFile = "\\src\\test\\resources\\resouces-to-upload\\Moshik_testPptx.pptx";
