...
public class TC15463AddPngFile {
	...
	public void setup() {
		...
		mangage_adhoc_courses_membership_window = PageFactory.initElements(driver,
		 ...
		 System.out.println("Starting the test: TC15463AddPngFile at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TC15463AddPngFile at " + DateToStr, "Starting the test: TC15463AddPngFile at " + DateToStr, LogAs.PASSED, null);	
	}
