...
public class TC15471UploadTheFile {
	...
	public void setup() {
		...
		mangage_adhoc_courses_membership_window = PageFactory.initElements(driver,
		 ...
		 System.out.println("Starting the test: TC15471UploadTheFile at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TC15471UploadTheFile at " + DateToStr, "Starting the test: TC15471UploadTheFile at " + DateToStr, LogAs.PASSED, null);	
	}
	...
	public void test15471() throws Exception {
		...
		//7. check that the additional content tab is on right recording tab
		record.verifyAdditionalContentTabIsOnRightOfRecordingTab();
		...
		driver = DriverSelector.getDriverForDownloadFile(System.getProperty("user.home") + File.separatorChar + "Downloads" + File.separatorChar);
