...
//
	...
	public void setup() {
		...
		delete_menu = PageFactory.initElements(driver, DeleteMenu.class);
		 ...
		 System.out.println("Starting the test: TC15635DeleteAProctoringRecordingAsInstructor at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TC15635DeleteAProctoringRecordingAsInstructor at " + DateToStr, "Starting the test: TC15635DeleteAProctoringRecordingAsInstructor at " + DateToStr, LogAs.PASSED, null);	
	}
	...
	@Test(description = "TC 15635 Delete A Proctoring Recording As Instructor")
	public void test15635() throws InterruptedException
	{
...
//		if(current_recording_list.contains(selected_recording_title)) {	
		if(current_recording_list.size() < initial_recording_list.size()) {
