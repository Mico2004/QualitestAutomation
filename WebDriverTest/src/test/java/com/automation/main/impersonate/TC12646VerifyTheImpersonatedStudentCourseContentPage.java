...
public class TC12646VerifyTheImpersonatedStudentCourseContentPage extends BaseTest {
...
//        //login As ins and add Student recordings, Test recordings, Additional content to the course
    ...
    private void validateCoursesListAreCorrect() {
        ...
        ATUManager.asserIsTrueAndReport(areListCoursesMatches && equals, "List of displayed courses is correct for this INSTRUCTOR", "", "");
