...
public class TestSuitePreSetCopyRecordings6 {
...
//		System.setProperty("webdriver.edge.driver", "src/test/resources/MicrosoftWebDriver.exe");
		...
		Date curDate = new Date();
		 ...
		 System.out.println("Starting the test: TestSuitePreSetCopyRecordings6 at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TestSuitePreSetCopyRecordings6 at " + DateToStr, "Starting the test: TestSuitePreSetCopyRecordings6 at " + DateToStr, LogAs.PASSED, null);
