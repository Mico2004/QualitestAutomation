...
public class TestSuitePreSetCopyRecordings10 {
...
//		System.setProperty("webdriver.edge.driver", "src/test/resources/MicrosoftWebDriver.exe");
		...
		Date curDate = new Date();
		 ...
		 System.out.println("Starting the test: TestSuitePreSetCopyRecordings at10 " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TestSuitePreSetCopyRecordings10 at " + DateToStr, "Starting the test: TestSuitePreSetCopyRecordings10 at " + DateToStr, LogAs.PASSED, null);
