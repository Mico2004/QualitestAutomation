...
public class TC15897ViewTheUploadedFile {
	...
	public void test15897() throws Exception {
		String fullPathToFile1 = "\\workspace\\QualitestAutomation\\resources\\documents\\chromedriver_win32.zip";
		String file_name1 = "chromedriver_win32.zip";
...
///delete old downloaded files
	...
	///record.waitForVisibility(driver.findElement(By.xpath("//*[@id=\"ItemSize2\"]/span")));
	    if((driver.findElement(By.xpath("//*[@id=\"ItemSize2\"]/span")).getText().contains("Mb"))&&(driver.findElement(By.xpath("//*[@id=\"ItemSize1\"]/span")).getText().contains("Kb"))&&(driver.findElement(By.xpath("//*[@id=\"ItemSize2\"]/span")).getText().contains(m))&&(driver.findElement(By.xpath("//*[@id=\"ItemSize1\"]/span")).getText().contains(k)))
	    {
