...
public class TC15464AddXlsFile {
	...
	public void setup() {
		...
		mangage_adhoc_courses_membership_window = PageFactory.initElements(driver,
		 ...
		 System.out.println("Starting the test: TC15464AddXlsFile at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TC15464AddXlsFile at " + DateToStr, "Starting the test: TC15464AddXlsFile at " + DateToStr, LogAs.PASSED, null);	
	}
	...
	@Test (description="TC 15464 Add Xls File")
	public void test15464() throws Exception {

		String fullPathToFile = "\\workspace\\QualitestAutomation\\resources\\documents\\Moshik_testXls.xls";
		String file_name = "Moshik_testXls.xls";
		// 1.load page
