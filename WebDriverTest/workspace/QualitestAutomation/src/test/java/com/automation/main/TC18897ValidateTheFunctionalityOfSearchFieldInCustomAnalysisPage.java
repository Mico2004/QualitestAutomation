...
public class TC18897ValidateTheFunctionalityOfSearchFieldInCustomAnalysisPage {
...
//		driver=new InternetExplorerDriver(capability);
		...
		edit_recording = PageFactory.initElements(driver, EditRecording.class);
		 ...
		 System.out.println("Starting the test: TC18897ValidateTheFunctionalityOfSearchFieldInCustomAnalysisPage at " + DateToStr);
		 ATUReports.add("Message window.", "Starting the test: TC18897ValidateTheFunctionalityOfSearchFieldInCustomAnalysisPage at " + DateToStr,
		 "Starting the test: TC18897ValidateTheFunctionalityOfSearchFieldInCustomAnalysisPage at " + DateToStr, LogAs.PASSED, null);
