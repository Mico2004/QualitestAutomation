...
//click message by subject name and give an index
 ...
 public void verifyEmailMessage(WebDriver driver,String subject,String sender,String comment_message) throws InterruptedException
 {
  ...
  String c=driver.findElement(By.xpath("/html/body")).getText();
	if((from.equals(sender))&&(comment.getText().contains(comment_message))&&(comment.getText().contains("From: Guest (rndsupport@tegrity.com)")))
   {
