...
public class TC17933VerifypastCourseWithStudentRecording {
	...
	public void test17929() throws Exception {
		...
		String course_with_one_student_recording = "CourseOneStudentRecordings" + sdf.format(date);
		tegrity.loadPage(tegrity.pageUrl, tegrity.pageTitle);
		...
		create_new_course_window.createNewCourse(course_with_one_student_recording, course_with_one_student_recording);
		Thread.sleep(1000);
		try {
		...
		// enroll first user
		mange_adhoc_course_enrollments.enrollInstructorToCourse(course_with_one_student_recording, for_enroll,
		...
		Thread.sleep(3000);
		copy.selectTargetCourseFromCourseList(course_with_one_student_recording);
		Thread.sleep(2000);
		...
		Thread.sleep(3000);
		course.selectCourseThatStartingWith(course_with_one_student_recording);
		Thread.sleep(3000);
		record.clickOnStudentRecordingsTab();
		Thread.sleep(2000);
		...
		mange_adhoc_course_enrollments.unEnrollInstructorToCourse(course_with_one_student_recording, instructor1,
				mangage_adhoc_courses_membership_window);
		Thread.sleep(4000);
		...
		course.verifyCourseExist(course_with_one_student_recording);
		...
		Thread.sleep(2000);
		/// 9.verify no student tab after delete
		record.verifyNoStudentTab();
		/// 10. USER automatically redirected to "Recordings" tab
		System.out.println(driver.findElement(By.xpath("//*[@id=\"main\"]/div[2]/ul/li[3]")).getAttribute("class"));
