...
public class TC17901CreatePastCourseAndVerifyAppearanceAccordinglyToEnrollementStatus  {
	...
	public void preTestCreateNewUser() throws InterruptedException {
		...
		instructor1 = "user03032016011609";
		instructor2 = "user203032016011609";
		student = "student03032016011609";
		 Date date = new Date();
		...
		int i = 1;
		 ...
		 course.signOut();
		 Thread.sleep(2000);
		 instructor2 = "user2" + sdf.format(date);
		 ...
		 create_new_user_window.createNewUser(student, student,
		 "abc@com.com", "111", "111");
		 Thread.sleep(1000);
		 ...
		 admin_dashboard_page.clickOnTargetSubmenuCourses("Manage Ad-hocCourses / Enrollments (Course Builder)");
		 ...
		 mangage_adhoc_courses_membership_window.searchForUser(student);
				 ...
				 mangage_adhoc_courses_membership_window.first_user_of_user_list.click();
				 Thread.sleep(1000);
				 // Add selected user to student list
		...
		//change ownership
		 ...
		 // 5. Click on create course href link
		 driver.switchTo().frame(0);
		 Thread.sleep(2000);
		 ...
		 Thread.sleep(3000);
		 mangage_adhoc_courses_membership_window.selectIrUserFromUserList(mangage_adhoc_courses_membership_window.instructor_elements_list, instructor1);
		 System.out.println("removed instructor 1");
		 Thread.sleep(1000);
		 // 8.Add selected user to instructor list
		 ...
		 Thread.sleep(5000);
		 // 10.Select first user from user list (the only user it found becauseof the uniq of the search)
		 mangage_adhoc_courses_membership_window.selectFirstUserFromUserList();
		 Thread.sleep(5000);
		 //11. Add selected user to instructor list
		 mangage_adhoc_courses_membership_window.clickOnAddSelectedUserToInstructorList();
		 Thread.sleep(5000);
	...
	public void test17901() throws InterruptedException {
		...
		tegrity.loginAdmin("Admin");
		Thread.sleep(2000);
		//5. Click on course builder href link
		...
		mange_adhoc_course_enrollments.unEnrollInstructorToCourse(past_course_a, instructor1, mangage_adhoc_courses_membership_window);
		 Thread.sleep(2000);
	    mange_adhoc_course_enrollments.clickOnFirstCourseMembershipButton();
		///9.check instructor 1 is unenrolled instructor2 enrolled and student enrolled as student
      Thread.sleep(3000);
      mangage_adhoc_courses_membership_window.isInstructorEnrolledToCourse(false, instructor1);	    
      Thread.sleep(3000);
      mangage_adhoc_courses_membership_window.isInstructorEnrolledToCourse(true, instructor2);	    
      Thread.sleep(3000);    
      mangage_adhoc_courses_membership_window.isStudentEnrolledToCourse(true,student);	    
      Thread.sleep(3000);    
			...
			//21.login as student
			  tegrity.loginCoursesByParameter(student); 
			   ...
			   //22.Click Past Courses Tab button (without selecting a recording)
				course = PageFactory.initElements(driver, CoursesHelperPage.class);
				//23.verify patcourses tab not exist
				course.verifyNoPastCoursesTab();
